Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/chieucold/NFCPassportReader.git"
  spec.license      = "MIT"
  spec.author       = { "Vmg" => "hoangchieukma@gmail.com" }
  spec.platform = :ios
  spec.ios.deployment_target = "14.0"

  spec.source       = { :git => "https://github.com/chieucold/NFCPassportReader.git", :tag => "#{spec.version}" }
